...
public class HandUpAdapter extends BaseExpandableListAdapter {
	...
	public HandUpAdapter(Context context) {
		...
		mListGroup = OrderManager.getOrderListDailHandUpyByStatus();
	}
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		if (convertView == null) {
			...
			holder.orderAccountNO = (TextView) convertView.findViewById(R.id.notpayAccountNo);
		...
		holder.orderAccountNO.setVisibility(View.VISIBLE);
		holder.orderAccountNO.setText(tmp.getOrder().getBillNo());
	...
	public class ViewHolder {
		...
		public TextView orderAccountNO;
	}
}
