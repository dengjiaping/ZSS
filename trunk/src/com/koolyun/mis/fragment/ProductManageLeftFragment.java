 ...
 * 商品列表界面
 */
public class ProductManageLeftFragment extends AbstractFragment implements OnClickListener {
	...
	private void initAndset() {
		...
		btn_product_category = (Button) allProduct.findViewById(R.id.btn_product_category);
		txt_product_name = (TextView) allProduct.findViewById(R.id.txt_product_name);
		btn_product_manual_input = (Button) allProduct.findViewById(R.id.btn_product_manual_input);
